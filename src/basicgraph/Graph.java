...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		List<Integer> vDegree = new ArrayList<Integer>();
		for (int i = 0; i < this.numVertices; i++) {
			vDegree.add(this.getInNeighbors(i).size()+this.getNeighbors(i).size());
		}
		Collections.sort(vDegree, Collections.reverseOrder());
		return vDegree;
	}
