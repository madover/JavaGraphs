...
public class GraphAdjMatrix extends Graph {
	 ...
	 */	
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> outDegreeFirstRow, outDegreeSecondRow = new ArrayList<Integer>();
		 outDegreeFirstRow = this.getNeighbors(v);
		 for (Integer i : outDegreeFirstRow) {
			 outDegreeSecondRow.addAll(this.getNeighbors(i));
		 }
		 return outDegreeSecondRow;
	}
